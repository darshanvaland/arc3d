$(document).ready(function () {
    ...
    var table = $('#industries_table').DataTable({
        processing: true,
        serverSide: true,
        ajax: window.APP_URLS.getIndustries,
        order: [[0, 'desc']],
        columns: [
            { data: 'id', name: 'id' },
    ...
    $(document).on('click', '.delete_industries', function () {
        ...
        var url = window.APP_URLS.deleteindustries.replace(':id' , id);
...
function validateAndPreviewImage() {
        const input = document.getElementById("industries_image");
        const file = input.files[0];
        const errorSpan = document.getElementById("span_industries_image");
        const previewImg = document.getElementById("preview_industries_image");
        const bannerId = document.getElementById("span_industries_image_id")?.value;
    ...
    document.getElementById("industries_image").addEventListener("change", function () {
