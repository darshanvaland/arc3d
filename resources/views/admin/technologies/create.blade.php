            ...
            <div class="row align-items-center">
                ...
                <div class="border-0 mb-4">
                    <div
                        ...
                        <h3 class="fw-bold mb-0">Add Technologies</h3>
                                ...
                                <div class="card mb-4 border">
                                    ...
                                    <div class="card-body row">
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">ShrotName <span
                                                    class="required-star">*</span></label>
                                            <input type="text" name="technologies_shortname"
                                                class="form-control @error('technologies_shortname') is-invalid @enderror"
                                                value="{{ old('technologies_shortname') }}" placeholder="Enter Technologies Short Name Here">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="technologies_fullname"
                                                ...
                                                value="{{ old('technologies_fullname') }}" placeholder="Enter Technologies Full Name Here">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="file" name="technologies_image" id="technologies_image"
                                                ...
                                                <span class="text-danger" id="span_technologies_image"></span>
                                            @error('technologies_image')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <div class="preview_technologies_image-zone mt-2 d-flex flex-wrap gap-2 position-relative">
                                            </div>
                                             <img id="preview_technologies_image" src="#" alt="Preview" class="mt-2" style="max-width: 100%; height: auto; display: none;" />
                                        </div> 
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="technologies_alt"
                                                ...
                                                value="{{ old('technologies_alt') }}" placeholder="Enter Alt Here">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="technologies_status"
                                                ...
                                                <option value="Active"
                                                    {{ old('technologies_status') == 'Active' ? 'selected' : '' }}>Active
                                                </option>
                                                <option value="In-Active"
                                                    {{ old('technologies_status') == 'In-Active' ? 'selected' : '' }}>Inactive
                                                </option>
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="url"
                                                ...
                                                value="{{ old('url') }}" placeholder="Enter Alt Here">
                                            @error('url')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="card mb-4 border">
                                            <div class="card mb-4 border">
                                                ...
                                                <div class="card-body">
                                                    <textarea name="technologies_desc" class="form-control @error('technologies_desc') is-invalid @enderror" rows="4"
                                                        id="technologies_desc">{{ old('technologies_desc') }}</textarea>
