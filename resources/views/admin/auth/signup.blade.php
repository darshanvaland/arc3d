                    ...
                    <div class="row g-0">
                        <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center rounded-lg auth-h100">
                            <div style="max-width: 25rem;">
                                ...
                                <!-- Image block -->
                                <div class="">           
                                    <img src="{{ asset('public/admin/assets/images/signup_image.png')}}" alt="login-img">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h100">
                            <div class="w-100 p-3 p-md-5 card border-0 shadow-sm" style="max-width: 32rem;">
                                <!-- Form -->
                                <form class="row g-1 p-3 p-md-4" method="post" action="{{ route('register') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="col-12">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="name" class="form-control form-control-lg" placeholder="John" value="{{ old('name') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-2">
                                            ...
                                            <input type="email" name="email" class="form-control form-control-lg" placeholder="name@example.com" value="{{ old('email') }}">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-2">
                                            <label class="form-label">Profile Picture</label>
                                            <input type="file" name="profile_picture" class="form-control form-control-lg" value="{{ old('profile_picture') }}">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-2">
