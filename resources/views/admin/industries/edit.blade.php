                                    ...
                                    <div class="card-body row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="industries_title"
                                                ...
                                                value="{{ old('industries_title', $industries->title) }}" placeholder="Enter Industries Here">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            @if($industries->image)
                                                <div class="mt-2">
                                                    <img id="preview_industries_image" src="{{ asset('public/admin/industries_image/' . $industries->image) }}" width="150" height="120" alt="{{ $industries->alt_tag }}">
                                                </div>
                                            @endif
                                        </div> 
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="industries_status"
                                                ...
                                                <option value="Active" {{ old('industries_status', $industries->status) == 'Active' ? 'selected' : '' }}>Active</option>
                                                <option value="In-Active" {{ old('industries_status', $industries->status) == 'In-Active' ? 'selected' : '' }}>Inactive</option>
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="industries_alt"
                                                ...
                                                value="{{ old('industries_alt', $industries->alt_tag) }}" placeholder="Enter Alt Here">
                                        ...
                                        <div class="card mb-4 border">
                                            ...
                                            <div class="card-body">
                                                <textarea name="industries_desc"
                                                    class="form-control @error('industries_desc') is-invalid @enderror"
                                                    rows="4" id="industries_desc">{{ old('industries_desc', $industries->description) }}</textarea>
